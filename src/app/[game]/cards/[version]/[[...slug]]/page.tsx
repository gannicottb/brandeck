...
export default async function Page({ params, searchParams }: {
  ...
  const diffWithVersion = segment == "diff" ? GameVersion.apply(gameVer.gameName, Version.fromString(value)) : undefined
  ...
  return <div>
    ...
    <Cards gameVer={gameVer} size={size} filters={filters} diffWith={diffWithVersion} />
  </div>
}